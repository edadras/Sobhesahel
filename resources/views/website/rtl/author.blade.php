...
{{--                                @endauth--}}
                            ...
                            <div class="authorLink">
                                ...
                                <a href="{{ route('website.rtl.author',['id' => $user['id'],'user_type' => isset($user['email']) ? 'user' : 'author']) }}">
                                    <p>
                                        {{ route('website.rtl.author',['id' => $user['id'],'user_type' => isset($user['email']) ? 'user' : 'author']) }}
                                    </p>
