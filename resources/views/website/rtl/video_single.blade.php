...
{{--                        @endif--}}
                        ...
                        <div class="videoPgLeft text-end" id="pageHead">
                            <div class="text">
                                <h2>
                                    {{ $post['title'] }}
                                </h2>
...
{{--                                        @auth--}}
{{--                                            @if($is_marked)--}}
{{--                                                <small @click="bookmark({{ $post['id'] }})" ref="bookmark_btn"--}}
{{--                                                       class="icon-Group-2344 icon-active"></small>--}}
{{--                                            @else--}}
{{--                                                <small @click="bookmark({{ $post['id'] }})" ref="bookmark_btn"--}}
{{--                                                       class="icon-Group-2344"></small>--}}
{{--                                            @endif--}}
{{--                                        @endauth--}}
                                    </li>
                                </ul>
