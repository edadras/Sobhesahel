                    ...
                    <div class="topSecBx">
                        ...
                        <div class="topSecLft">
                            ...
                            <div class="topNewsRow">
                                @foreach(collect($three_post)->take(3) as $item)
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="head homPgTitle">
                            <span></span>
                            <p><a class="text-decoration-none" href="">آخرین اخبار</a></p>
                        </div>
                        <div class="catTwoRow">
                            @for($i = 0;$i < 3; $i++)
                                <div class="catTwoBox">
                                    ...
                                    <div class="body">
                                        @foreach(collect($latest)->skip($i * 10)->take(10) as $item)
                                            <a href="{{ $item['url'] }}"
                                               class="transitionCls">
                                                <img style="width: 55px; height: 55px;" src="{{ $item['image_small'] }}" alt="img" loading="lazy"/>
                                                <div class="text-end pt-1">
                                                    <p style="font-size: 13px">
                                                        {{ $item['title'] }}
                                                        <span style="display: inline-block; width: auto"> ({{$item['posted_at_ago']}}) </span>
                                                    </p>
                                                </div>
                                            </a>
                                        @endforeach
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            @foreach(collect($video)->take(1) as $item)
                                <div class="mainVideo position-relative">
                                    ...
                                    @if($item['embed'] != null)
                                        ...
                                        {!! $item['embed'] !!}
                                    @endif
                                    <a href="{{ $item['url'] }}" class="vidOverlay position-absolute" style="text-decoration: none; color: inherit; display: block;">
                                        <strong>
                                            {{ $item['title'] }}
                                        </strong>
                                        {!! $item['short_description'] !!}
                        ...
                        <div class="text-center mt-4 mb-3">
                            <a href="{{ route('website.rtl.index', ['type' => 'video']) }}" class="transitionCls" style="display: inline-block; padding: 12px 40px; background: #007bff; color: white; text-decoration: none; border-radius: 5px; font-weight: 500; font-size: 16px;">
                                نمایش همه ویدیوها
                            </a>
                        </div>
                    </div>
