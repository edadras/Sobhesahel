...
class NoteResource extends Resource implements HasShieldPermissions
{
    ...
    protected static ?string $label = 'یادداشت';
                    ...
                    Forms\Components\Grid::make()->schema([
                        ...
                        Forms\Components\Section::make('سئو')->schema([
                            Forms\Components\TextInput::make('seo_title')
                                ->label('عنوان سئو')
                                ->helperText('عنوان یادداشت به عنوان پیشفرض'),
                            Forms\Components\Textarea::make('meta_desc')->label('کلمات کلیدی')
                        ])->description('تنظیمات یادداشت در گوگل')
                    ])->columnSpan(4),
                ])
            ]);
    }
